...
GF.TECHNIQUES = [
  { id: "active_recall", icon: "🧩", name: "Active Recall", tag: "Retrieval", short: "Test yourself instead of re-reading.",
    what: "Pulling information out of your memory — with questions, flashcards, or blank-page recall — instead of passively reviewing it.",
    how: ["Close your notes completely.", "Write or say everything you can remember about the topic.", "Check what you missed, then try again.", "Turn the weak spots into flashcards."],
    why: "The single most effective study technique in the research. The effort of retrieving is exactly what strengthens the memory.",
    link: { view: "flashcards", label: "Open Memory Lab" } },
  { id: "spaced_repetition", icon: "🔁", name: "Spaced Repetition", tag: "Memory", short: "Review on a schedule, not all at once.",
    what: "Revisiting material at growing intervals (1 day, 3 days, 1 week…) so you review each thing right before you'd forget it.",
    how: ["Study a topic today.", "Review it tomorrow, then in 3 days, then a week.", "Stretch the gap each time you get it right.", "Let Memory Lab schedule it for you."],
    why: "Beats cramming by roughly 2× for long-term memory — and takes less total time.",
    link: { view: "flashcards", label: "Open Memory Lab" } },
  { id: "pomodoro", icon: "🍅", name: "Pomodoro Technique", tag: "Focus", short: "25 min deep work, 5 min break.",
    what: "Work in focused 25-minute sprints separated by short breaks to beat procrastination and protect attention.",
    how: ["Pick ONE task.", "Set a 25-minute timer and work — no phone, no tabs.", "Take a 5-minute break.", "After 4 rounds, take a longer break."],
    why: "Short deadlines create urgency and make starting easy — the hardest part of studying.",
    link: { view: "focus", label: "Open Focus Engine" } },
  { id: "feynman", icon: "🧒", name: "Feynman Technique", tag: "Understanding", short: "Explain it simply, like to a child.",
    what: "Explaining a concept in plain language until a beginner could understand it — which instantly exposes what you don't really know.",
    how: ["Pick a concept.", "Explain it out loud in simple words.", "Notice where you get stuck or vague.", "Go back to the source, then re-explain."],
    why: "If you can't explain it simply, you don't understand it yet. This finds the gaps fast.",
    link: { view: "coach", label: "Use the AI Coach" } },
  { id: "interleaving", icon: "🔀", name: "Interleaving", tag: "Practice", short: "Mix topics in one session.",
    what: "Switching between related topics or problem types within a study session, instead of doing one type over and over.",
    how: ["Pick 2–3 related topics.", "Alternate between them as you practise.", "Resist finishing one before starting the next.", "Mix question types in revision."],
    why: "Forcing your brain to switch and choose the right method builds far stronger, more flexible recall.",
    link: { view: "today", label: "See Today's Plan" } },
  { id: "practice_testing", icon: "📝", name: "Practice Testing", tag: "Retrieval", short: "Do past papers, exam-style.",
    what: "Sitting real past papers or quizzes under timed, exam-like conditions — the closest thing to the real exam.",
    how: ["Get a past paper.", "Time yourself with no notes.", "Mark it honestly against the memo.", "Re-study only what you got wrong."],
    why: "Tests aren't just measurement — testing yourself is one of the best ways to actually learn.",
    link: { view: "exams", label: "Open Exam Center" } },
  { id: "eighty_twenty", icon: "🎯", name: "The 80/20 Rule", tag: "Strategy", short: "Focus on what earns the most marks.",
    what: "Spending most of your energy on the ~20% of content that delivers ~80% of the marks (and your weakest high-value areas).",
    how: ["Check the exam's mark allocation per topic.", "List your weakest high-value topics.", "Study those first, while fresh.", "Only then polish the rest."],
    why: "Not all study time is equal. Working on the highest-leverage topics moves your grade the most.",
    link: { view: "marks", label: "See your subjects" } },
  { id: "dual_coding", icon: "🖼️", name: "Dual Coding", tag: "Memory", short: "Pair words with visuals.",
    what: "Combining words with diagrams, timelines, or sketches so your brain stores the idea two ways at once.",
    how: ["Take a set of notes.", "Draw it as a diagram, flow or timeline.", "Label it from memory.", "Quiz yourself on the visual."],
    why: "Two memory routes (verbal + visual) give you two ways to recall it under pressure.",
    link: null },
  { id: "mnemonics", icon: "🧠", name: "Mnemonics", tag: "Memory", short: "Turn lists into memorable cues.",
    what: "Memory tricks — acronyms, rhymes, vivid stories or a memory palace — for things you must memorise in order.",
    how: ["Find the list/sequence you must memorise.", "Build an acronym or silly story from it.", "Make it vivid and weird — weird sticks.", "Recall it a few times to lock it in."],
    why: "Your brain remembers vivid, unusual, connected things far better than dry lists.",
    link: { view: "coach", label: "Ask the AI Coach" } },
  { id: "time_blocking", icon: "📅", name: "Time Blocking", tag: "Focus", short: "Give every task a fixed slot.",
    what: "Scheduling specific study tasks into fixed time slots in your day, so studying happens by plan, not by mood.",
    how: ["List today's study tasks.", "Give each a realistic time slot.", "Protect those slots like appointments.", "Let the Today planner rank them for you."],
    why: "A task with a time and place gets done; a vague 'I'll study later' usually doesn't.",
    link: { view: "today", label: "Open Today's Plan" } },
  { id: "teach_it", icon: "👩‍🏫", name: "Teach It", tag: "Understanding", short: "Teach someone to find your gaps.",
    what: "Teaching the material to a friend, a pet, or an empty room — the act of teaching reveals exactly what you haven't mastered.",
    how: ["Pick a topic you 'know'.", "Teach it out loud, start to finish.", "Note every question you couldn't answer.", "Go relearn those, then teach again."],
    why: "Teaching forces you to organise and retrieve knowledge — two of the strongest learning actions.",
    link: null },
  { id: "sleep", icon: "😴", name: "Sleep On It", tag: "Wellbeing", short: "Sleep locks in what you learned.",
    what: "Getting proper sleep — especially the night after studying and before an exam — because your brain consolidates memory while you sleep.",
    how: ["Study earlier, not at 2am.", "Review key material right before bed.", "Sleep 7–9 hours, especially pre-exam.", "Never trade sleep for last-minute cramming."],
    why: "Pulling an all-nighter wrecks recall and focus. Sleep is part of studying, not the opposite of it.",
    link: null },
];
